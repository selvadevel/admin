...
<html>
  <head>
    ...
    <link href="{base_url}css/config.css" rel="stylesheet" type="text/css" />
    <link href="{base_url}bootstrap/css/changes.css" rel="stylesheet" type="text/css" />
 	<!-- jQuery 2.1.3 -->
  ...
  <body class="skin-blue">
    <div class="wrapper">
       <?php  $getRow=get_data('tbl_users',array("id"=>$this->session->userdata('adminId')))->row();?>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{base_url}uploads/profile_images/<?php echo $getRow->profile_image?>" class="user-image" alt="User Image"/>
                  <span class="hidden-xs"><?php echo ucfirst($this->session->userdata('adminName'));?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{base_url}uploads/profile_images/<?php echo $getRow->profile_image?>" class="img-circle" alt="User Image" />
                    <p>
                       <?php echo ucfirst($this->session->userdata('adminName'));?>
                     <small>Last Login <?php echo date("D M j G:i:s",strtotime($getRow->updated_date));?></small>
                    </p>
                  </li>
                  <!-- Menu Footer-->
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo site_url('admin/profile_setting');?>" class="btn btn-default btn-flat">Profile</a>
                    </div>
